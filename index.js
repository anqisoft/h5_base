...
function parsePageParamsFromUrl(url) {
    ...
    const PAPER_WIDTH = parseFloat(getValueByUrlParamNam('width', '0')) || (A3 ? LANDSCAPE ? 420 : 297 : LANDSCAPE ? 297 : 210);
    const PAPER_HEIGHT = parseFloat(getValueByUrlParamNam('height', '0')) || (A3 ? LANDSCAPE ? 297 : 420 : LANDSCAPE ? 210 : 297);
...
export { parsePageParamsFromUrl as parsePageParamsFromUrl };
export { getPageCss as getPageCss };
export { setF1Content as setF1Content };
export { getNumbersArray as getNumbersArray };
...
export { createPageElement as createPageElement };
export { createSvgElement as createSvgElement };
export { createSvgGElement as createSvgGElement };
export { createSvgAndGElement as createSvgAndGElement };
export { appendSvgAndG as appendSvgAndG };
export { createTopSvgElement as createTopSvgElement };
